...
import { getThemeDesign } from "@nw/widget-core";

interface WidgetShellProps {
  params: { theme?: string; bg?: string };
  children: ReactNode;
  className?: string;
}
